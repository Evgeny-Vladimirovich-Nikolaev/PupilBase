 ...
 * @author Nobilis
 */
public class AllAchievment extends javax.swing.JFrame {
    private File f;
    private ArrayList<Pupil> Base;
    private ArrayList<Pupil> Delete;
    private boolean editable = false;
    public AllAchievment() {
        initComponents();
    }
    public AllAchievment(File file, ArrayList b, ArrayList del) {
        f = file;
        Base = b;
        Delete = del;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Специальность");
        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18));

        jLabel3.setText("Сольфеджио");
        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18));
        jLabel3.setAutoscrolls(true);

        jLabel4.setText("Муз. литер.");
        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18));
        jLabel4.setAutoscrolls(true);

        jLabel5.setText("Доп. инструмент");
    ...
    private void getTable(){
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [Base.size()][44] ,
            new String [] {
                "Фамилия, имя", "кл.", "I", "II", "III", "IV", "год.", "экз.", "итог.", "I", "II", "III", "IV", "год.", "экз.", "итог.", "I", "II", "III", "IV", "год.", "экз.", "итог.", "I", "II", "III", "IV", "год.", "экз.", "итог.", "I", "II", "III", "IV", "год.", "экз.", "итог.", "I", "II", "III", "IV", "год.", "экз.", "итог."
            }
        ){
            boolean[] canEdit = new boolean [] {
                false, false, editable, editable, editable, editable, editable, 
        ...
        for (int row=2; row<44; row+=7){
            jTable1.getColumnModel().getColumn(row).setMinWidth(22); 
            jTable1.getColumnModel().getColumn(row+1).setMinWidth(22); 
            jTable1.getColumnModel().getColumn(row+2).setMinWidth(22); 
            jTable1.getColumnModel().getColumn(row+3).setMinWidth(22); 
            jTable1.getColumnModel().getColumn(row+4).setMinWidth(29);
            jTable1.getColumnModel().getColumn(row+5).setMinWidth(29); 
            jTable1.getColumnModel().getColumn(row+6).setMinWidth(29); 
            jTable1.getColumnModel().getColumn(row).setMaxWidth(22); 
            jTable1.getColumnModel().getColumn(row+1).setMaxWidth(22); 
            jTable1.getColumnModel().getColumn(row+2).setMaxWidth(22); 
            jTable1.getColumnModel().getColumn(row+3).setMaxWidth(22); 
            jTable1.getColumnModel().getColumn(row+4).setMaxWidth(29); 
            jTable1.getColumnModel().getColumn(row+5).setMaxWidth(29); 
            jTable1.getColumnModel().getColumn(row+6).setMaxWidth(29);
        }
    ...
    private void writeAchievment(){
        ...
        for(int i=0; i< Base.size(); i++){
            for(int k=2; k<23; k++){
                achiev += (String)jTable1.getValueAt(i, k) + "¤";
            }
            for(int k=30; k<44; k++){
                achiev += (String)jTable1.getValueAt(i, k) + "¤";
            }
...
// Симво 'µ' отделяет в файле удалённые записи            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllAchievment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllAchievment().setVisible(true);
            }
        });
    }
